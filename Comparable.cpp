 ...
 * Comparable class function definitions: The Comparable class is an object that encapsulates a character.
...
* @return: input stream
*/
istream& operator>>(istream& in, Comparable& character) {
	in >> character.storedChar;
	return in;
}
...
*/
ostream& operator<<(ostream& os, Comparable& character) {
	cout << character.storedChar;
	return os;
}
...
*/
Comparable& Comparable::operator=(const Comparable& rhs) {
	if (this == &rhs)
		return *this;
	this->storedChar = rhs.storedChar;
	return *this;
}
